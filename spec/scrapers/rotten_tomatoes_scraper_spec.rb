...
RSpec.describe Rotten_Tomatoes_Scraper, :type => :feature do
  describe 'reviews' do
    ok_scraper = Rotten_Tomatoes_Scraper.new('http://www.rottentomatoes.com/m/godfather/', ENV['USER_AGENT_STRING'], 5, false)
    empty_scraper = Rotten_Tomatoes_Scraper.new('', ENV['USER_AGENT_STRING'], 5, false)
